...
void applicationLoop() {
	...
	while (psi) {
		...
		//1.Render del buffer de profundidad
		...
		//Solo para debug se visualiza el render anterior
		glViewport(0, 0, screenWidth, screenHeight);
		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
...
void prepareScene(){//Si se agregan otros objetos en la escena se debe settear su shader
...
void prepareDepthScene(){//Si se agregan otros objetos en la escena se deben settear el shader de profundidad 
