...
std::vector<glm::vec3> lamp1Position = { glm::vec3(-7.03, 0, -19.14), glm::vec3(
		24.41, 0, -34.57), glm::vec3(-10.15, 0, -54.10), glm::vec3(16.01, 0.0, -53.12) };
std::vector<float> lamp1Orientation = { -17.0, -82.67, 23.70, -33.93 };
//Lamp 2 pisitions
std::vector<glm::vec3> lamp2Position = { glm::vec3(-36.52, 0, -23.24),
		glm::vec3(-52.73, 0, -3.90), glm::vec3(17.19, 0.0, -14.06), glm::vec3(25.39,0.0,-0.97), glm::vec3(34.76, 0.0, -14.64) };//Añadimos 3 lamparas del tipo 2
std::vector<float> lamp2Orientation = { 21.37 + 90, -65.0 + 90, 43.65 + 90, 38.6 + 90, 39.1 + 90 };
//Lamp 3 positions
std::vector<glm::vec3> lamp3Position = { glm::vec3(11.71, 0.0, -70.32),
		glm::vec3(27.14, 0.0, -79.68), glm::vec3(46.48, 0.0, -90.04) };//Añadimos 3 lamparas del tipo 3
std::vector<float> lamp3Orientation = { 31.83, 35.36, 36.71 };
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelLamp3.loadModel("../models/Floor Lamp 2/Floor_Lamp_02.obj");
...
void applicationLoop() {
	...
	while (psi) {
		...
		*******************************************/
		...
		shaderMulLighting.setVectorFloat3("spotLights[0].direction", glm::value_ptr(glm::vec3(0, -1, 0.0)));
		shaderMulLighting.setFloat("spotLights[0].constant", 1.0);
		shaderMulLighting.setFloat("spotLights[0].linear", 0.014);
		shaderMulLighting.setFloat("spotLights[0].quadratic", 0.007);
		shaderMulLighting.setFloat("spotLights[0].cutOff", cos(glm::radians(12.5f)));
		shaderMulLighting.setFloat("spotLights[0].outerCutOff", cos(glm::radians(16.0f)));
		shaderTerrain.setVectorFloat3("spotLights[0].light.ambient", glm::value_ptr(glm::vec3(0.0, 0.0, 0.0)));
		shaderTerrain.setVectorFloat3("spotLights[0].light.diffuse", glm::value_ptr(glm::vec3(0.2, 0.35, 0.2)));
		shaderTerrain.setVectorFloat3("spotLights[0].light.specular", glm::value_ptr(glm::vec3(0.3, 0.3, 0.3)));
		shaderTerrain.setVectorFloat3("spotLights[0].position", glm::value_ptr(spotPosition));
		shaderTerrain.setVectorFloat3("spotLights[0].direction", glm::value_ptr(glm::vec3(0, -1, 0.0)));
		...
		for (int i = 0; i < lamp2Position.size(); i++) {
			...
			matrixAdjustLamp = glm::translate(matrixAdjustLamp, glm::vec3(0.76445f, 4.994f, 0.0f));
			glm::vec3 lampPosition = matrixAdjustLamp[3];
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.02)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].light.specular", glm::value_ptr(glm::vec3(0.6, 0.5, 0.02)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].position", glm::value_ptr(glm::vec3(lampPosition)));
			...
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.02)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].light.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].light.specular", glm::value_ptr(glm::vec3(0.6, 0.5, 0.02)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].position", glm::value_ptr(glm::vec3(lampPosition)));
		...
		for (int i = 0; i < lamp2Position.size(); i++) {
			...
			modelLamp2.setOrientation(glm::vec3(0.0, lamp2Orientation[i], 0.0));
